(function(window) {
    var app = (function(document) {
        ...
        var render_function = function() {
            $("#twitter-wjs").remove();
            $("#feed").css("overflow-y", "scroll");
            $("#feed").addClass("news_display");
        ...
        var render_tweets = function() {
            ...
            anchor.setAttribute("data-chrome", "noheader");

            $("#twitter_feed").append(anchor);
            $("#twitter_feed").addClass("twitter_display");
        ...
        var event_bind = function() {
            ...
            $("#twitter_tab").one("click", function() {
            	render_tweets();
                $("#twitter_tab").addClass("tw_class");
                $(".news_display").hide();
